<form class="credential-form new-credential">
    ...
    {{--<div class="form-group">--}}
        {{--<label>Admin</label> <input v-model="newCredential.type" type="radio" name="type" value="1">--}}
        {{--<label>Member</label> <input v-model="newCredential.type" type="radio" name="type" value="0" checked>--}}
    {{--</div>--}}
    <div class="form-group">
        <label>Name</label>
    ...
    {{--<div class="form-group type-@{{ newCredential.type }}">--}}
        {{--<div class="col-xs-6 no-padding-left">--}}
            ...
            {{--<input v-model="newCredential.hostname" class="form-control other" type="text" name="hostname" placeholder="hold">--}}
        {{--</div>--}}
        {{--<div class="col-xs-6 no-padding-right">--}}
            {{--<label>BLANKSPACE</label>--}}
            {{--<input v-model="newCredential.port" class="form-control other" type="text" name="port" placeholder="hold">--}}
        {{--</div>--}}
