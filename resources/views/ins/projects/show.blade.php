...
<div id="project">
    <div class="row" xmlns:v-on="http://www.w3.org/1999/xhtml" xmlns:v-on="http://www.w3.org/1999/xhtml">
        <div class="col-xs-12 page-title-section">
            ...
            <br><h2 class="pull-left"> @{{ project.client_name }} </h2></br>

            <div class="clearfix"></div>

            <h3 class="pull-left">Project Name: @{{ project.name }} <a v-on:click="startProjectEditMode()" class="show-on-hover btn btn-default" title="Edit Project"><i class="ion-edit"></i></a></h3>

            <div class="clearfix"></div>

            <br><h4 class="centered"> Location: @{{ project.location }} </h4></br>

            <h4 class="centered"> Project Start: @{{ project.project_start }} </h4>

            <br><h4 class="centered"> Project Finish: @{{ project.project_finish }} </h4></br>

            <h4 class="centered"> # of Calendar Days: @{{ project.days }} </h4>

            <br><h4 class="centered"> Contract Amount (Php): @{{ project.budget }} </h4></br>
