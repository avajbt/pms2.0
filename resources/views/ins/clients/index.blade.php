	...
	<div class="popup-form new-client">
		...
		<section>
			<form>
				...
				<input v-model="client.name" placeholder="Client/Company Name" type="text" class="form-control first">
	...
	<div class="popup-form new-project">
		...
		<section>
			<form>
                ...
                <input v-model="newProject.client_name" placeholder="Client Name" type="text" class="form-control first">
                <input v-model="newProject.location" placeholder="Location" type="text" class="form-control first">
                <input v-model="newProject.project_start" placeholder="Project Start YEAR-MONTH-DAY" type="text" class="form-control first">
                <input v-model="newProject.project_finish" placeholder="Project Finish YEAR-MONTH-DAY" type="text" class="form-control first">
                <input v-model="newProject.days" placeholder="# of Calendar Days" type="text" class="form-control first">
                <input v-model="newProject.Budget" placeholder="Project Budget" type="text" class="form-control first">
			</form>
		</section>
		<footer>
	...
	<div style="z-index: 20" class="popup-form update-client">
        ...
        <section>
            <form>
                ...
                <input v-model="currentClient.name" placeholder="Client/Company Name" type="text" class="form-control first">
                <input v-model="currentClient.email" placeholder="Email" type="text" class="form-control">
                <input v-model="currentClient.point_of_contact" placeholder="Name Of Contact" type="text" class="form-control">
